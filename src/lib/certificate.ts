...
export const LEVEL_STATEMENT: Record<Level, string> = {
  beginner: "إتقان أساسيات الذكاء الاصطناعي وأدواته وكتابة الطلب",
  intermediate: "إتقان هندسة الطلب المتقدمة، خريطة الأدوات، وبناء الأتمتة",
  advanced: "إتقان بناء الأنظمة والوكلاء والمنتجات الحقيقية بالذكاء الاصطناعي",
};
